$(document).ready(function() {
  ...
  console.log(data_sales.length);
  var ctx_creator = document.getElementById("creator-chart").getContext("2d");
  var ctx_product = document.getElementById("product-chart").getContext("2d");
  var ctx_sales = document.getElementById("sales-chart").getContext("2d");
